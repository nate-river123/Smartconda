public Snake calculatePositions(Snake snake, Food food){
  ...
  SnakeBody tail = new SnakeBody(snake.snakeBodyArr.get(snake.snakeBodyArr.size()-1).getx(),snake.snakeBodyArr.get(snake.snakeBodyArr.size()-1).gety(),snake.snakeBodyArr.get(snake.snakeBodyArr.size()-1).getdx(),snake.snakeBodyArr.get(snake.snakeBodyArr.size()-1).getdy(),snake.snakeBodyArr.get(snake.snakeBodyArr.size()-1).getsegmentSize());
